...
**Autonomous Agents** are entities in a program that make their own choices based on what they can percieve in a given environment. Here, we will be focusing entirely on how they decide to move.
